...
class Screen3 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const HomePage(title: 'pikaritos"i"'),
    );
  }
}
...
class _HomePageState extends State<HomePage> {
            ...
            children: [
              Column(
                ...
                children: const <Widget>[
                  Image(
                    image: AssetImage("assets/images/abeja.png"),
                    fit: BoxFit.cover,
                  ),
                ],
              ),
    ...
    return StateNotifierBuilder<ScribbleState>(
      ...
      builder: (context, state, _) => Column(
        ...
        children: [
          ...
          _buildColorButton(context, color: Colors.pinkAccent, state: state),
        ],
      ),
    );
  }
  ...
  Widget _buildNexpage(BuildContext context) {
    return FloatingActionButton.small(
      tooltip: "next page",
      onPressed: () {
